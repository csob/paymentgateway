...
<html>
    ...
    <body>
        <pre><?php
            ...
            $closePayment = false;
            $merchantData = null;
            if (!array_key_exists($_POST ['currency'], Constants::$CURRENCY)) {
                throw new Exception('Unsupported currency');
            }
            $currency = $_POST ['currency'];

            if (!array_key_exists($_POST ['language'], Constants::$LANGUAGE)) {
            ...
            $data = createPaymentInitData($merchantId, $orderNo, $dttm, $totalAmount, $returnUrl, $cart, $description, $customerId, $privateKey, $privateKeyPassword, $closePayment, $merchantData, $returnMethodPOST, $currency, $language);
