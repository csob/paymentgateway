package cz.monetplus.mips.eapi.v17.connector.entity.ext;
...
@JsonSubTypes({ @JsonSubTypes.Type(value = TrxDatesExtension.class, name = "trxDates"), @JsonSubTypes.Type(value = MaskedClnRPExtensionV16.class, name = "maskClnRP")})
