package cz.monetplus.mips.eapi.v16.connector.config;
...
public class JaxRsClientConfig {
	...
	@Bean
	public INativeAPIv16Resource getNativeAPIv1ResourceRestClient() {
		return new JaxRsClientStarter<INativeAPIv16Resource>().start(INativeAPIv16Resource.class, url, 
