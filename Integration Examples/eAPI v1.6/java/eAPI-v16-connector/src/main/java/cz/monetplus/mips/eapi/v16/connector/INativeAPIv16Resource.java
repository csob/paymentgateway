package cz.monetplus.mips.eapi.v16.connector;
...
@Path( "/api/v1.6" )
public interface INativeAPIv16Resource {
	...
	@Path( "/payment/oneclick/init" ) 
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	@POST
	Response paymentOneclickInit(PayOneclickInitReq req); 

	@Path( "/payment/oneclick/start" ) 
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	@POST
	Response paymentOneclickStart(PayReq req); 
