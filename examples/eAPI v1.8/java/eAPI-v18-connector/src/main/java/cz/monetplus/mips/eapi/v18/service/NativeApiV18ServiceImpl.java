...
import cz.monetplus.mips.eapi.v18.connector.entity.PayCloseReq;
...
public class NativeApiV18ServiceImpl implements NativeApiV18Service  {
	...
	private final INativeAPIv18Resource nativeApiResource;
    ...
    @Autowired
	public NativeApiV18ServiceImpl(INativeAPIv18Resource nativeApiResource, CryptoService cryptoService) {
