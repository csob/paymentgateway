...
namespace CsobGatewayClientExample.Communication.DataObjects
{
    public class ApiBase
    {
	    ...
	    public static readonly string[] CURRENCY_ALLOWED_VALUES = new string[] { "CZK", "EUR", "USD", "GBP", "HUF", "PLN", "HRK", "RON", "NOK", "SEK" };
	    public static readonly string[] LANGUAGE_ALLOWED_VALUES = new string[] { "cs", "en", "de", "fr", "hu", "it", "ja", "pl", "pt", "ro", "ru", "sk", "es", "tr", "vi", "hr", "sl", "sv" };
