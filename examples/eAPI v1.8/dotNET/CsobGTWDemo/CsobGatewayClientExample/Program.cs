        ...
        private static async void Start(GatewayClient gatewayClient, int value)
        {
            ...
            switch (value)
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    response = await gatewayClient.CallOneClickInitAsync();
                    var responseObjectTemp = JsonConvert.DeserializeObject<PayRes>(response.ResponseValue);
                    paymentId = responseObjectTemp.PayId;
                    break;
                case 10:
                    if (!CheckPaymentId())
                        return;
                    ...
                    break;
                case 11:
                    response = await gatewayClient.CallOneClickEchoAsync();
                    break;
            }
