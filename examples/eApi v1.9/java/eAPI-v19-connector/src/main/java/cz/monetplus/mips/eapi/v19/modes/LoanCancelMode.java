...
@Component
@Slf4j
public class LoanCancelMode implements RunMode {
    private final ExamplesService examplesService;

    public LoanCancelMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
			...
			PaymentResponse res = examplesService.loanCancel(aConfig.payId, aConfig.cancelReason);
    ...
    public RunModeEnum getMode() {
        return RunModeEnum.LOAN_CANCEL;
    }
