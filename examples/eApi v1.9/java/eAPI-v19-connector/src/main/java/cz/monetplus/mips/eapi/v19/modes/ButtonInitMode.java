...
import cz.monetplus.mips.eapi.v19.connector.entity.responses.ButtonInitResponse;
...
@Slf4j
@Component
public class ButtonInitMode implements RunMode {
    private final ExamplesService examplesService;

    public ButtonInitMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            ButtonInitResponse res = examplesService.buttonInit(f);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.BUTTON_INIT;
    }
}
