...
import cz.monetplus.mips.eapi.v19.connector.entity.responses.LoanInitResponse;
...
@Slf4j
@Component
public class LoanInitMode implements RunMode {
    private final ExamplesService examplesService;

    public LoanInitMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            LoanInitResponse res = examplesService.loanInit(f);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.LOAN_INIT;
    }
}
