...
@Slf4j
@Component
public class MallpayRefundMode implements RunMode {
    private final ExamplesService examplesService;

    public MallpayRefundMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            PaymentResponse res = examplesService.mallpayRefund(f, aConfig.payId);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.MALLPAY_REFUND;
    }
}
