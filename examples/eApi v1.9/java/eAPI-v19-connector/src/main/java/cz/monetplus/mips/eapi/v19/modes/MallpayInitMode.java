...
import cz.monetplus.mips.eapi.v19.connector.entity.responses.MallpayInitResponse;
...
@Slf4j
@Component
public class MallpayInitMode implements RunMode {
    private final ExamplesService examplesService;

    public MallpayInitMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            MallpayInitResponse res = examplesService.mallpayInit(f);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.MALLPAY_INIT;
    }
}
