...
@Slf4j
@Component
public class LoanLogisticsMode implements RunMode {
    private final ExamplesService examplesService;

    public LoanLogisticsMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            PaymentResponse res = examplesService.loanLogistics(f);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.LOAN_LOGISTICS;
    }
}
