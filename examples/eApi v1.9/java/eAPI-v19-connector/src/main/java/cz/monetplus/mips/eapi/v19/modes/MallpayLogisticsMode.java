...
@Slf4j
@Component
public class MallpayLogisticsMode implements RunMode {
    private final ExamplesService examplesService;

    public MallpayLogisticsMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            PaymentResponse res = examplesService.mallpayLogistics(f, aConfig.payId);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.MALLPAY_LOGISTICS;
    }
}
