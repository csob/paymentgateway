...
import cz.monetplus.mips.eapi.v19.connector.entity.responses.OneclickProcessResponse;
...
@Slf4j
@Component
public class OneclickProcessMode implements RunMode {
    final
    ExamplesService examplesService;

    public OneclickProcessMode(ExamplesService examplesService) {
    ...
    public void proc(ArgsConfig aConfig) {
        try {
            ...
            OneclickProcessResponse response = examplesService.oneclickProcess(aConfig.payId);
    ...
    public ArgsConfig.RunModeEnum getMode() {
        return ArgsConfig.RunModeEnum.ONECLICK_PROCESS;
    }
}
